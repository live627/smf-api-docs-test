...
---|---|---
`php int`|`php $split1_ID_TOPIC`|The ID of the topic we're splitting
`php array`|`php $splitMessages`|The IDs of the messages being split
`php string`|`php $new_subject`|The subject of the new topic
...
Type|Parameter|Description
---|---|---
`php array`|`php $topics`|The IDs of the topics to merge
