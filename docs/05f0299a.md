...
Type|Parameter|Description
---|---|---
`array`|`$logs`|an array of logs, each log contains the following keys:<br>- bantype: a known type of ban (ip_range, hostname, email, user, main_ip)<br>- value: the value of the bantype (e.g. the IP or the email address banned)
